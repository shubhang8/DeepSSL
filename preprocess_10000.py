...
np.savetxt('./DNABert/examples/DeepSea_data/3_mediem/dev.tsv.gz', test_kmers, fmt='%s', delimiter='\t')

print("starting training 3-mers")
train_kmers = get_kmers(train_inputs, train_labels, dna_dict, k)
np.savetxt('./DNABert/examples/DeepSea_data/3_mediem/train.tsv.gz', train_kmers, fmt='%s', delimiter='\t')
...
test_kmers = get_kmers(test_inputs, test_labels, dna_dict, k)
np.savetxt('./DNABert/examples/DeepSea_data/4_mediem/dev.tsv.gz', test_kmers, fmt='%s', delimiter='\t')

print("starting training 4-mers")
train_kmers = get_kmers(train_inputs, train_labels, dna_dict, k)
np.savetxt('./DNABert/examples/DeepSea_data/4_mediem/train.tsv.gz', train_kmers, fmt='%s', delimiter='\t')
...
test_kmers = get_kmers(test_inputs, test_labels, dna_dict, k)
np.savetxt('./DNABert/examples/DeepSea_data/5_mediem/dev.tsv.gz', test_kmers, fmt='%s', delimiter='\t')

print("starting training 5-mers")
train_kmers = get_kmers(train_inputs, train_labels, dna_dict, k)
np.savetxt('./DNABert/examples/DeepSea_data/5_mediem/train.tsv.gz', train_kmers, fmt='%s', delimiter='\t')
...
test_kmers = get_kmers(test_inputs, test_labels, dna_dict, k)
np.savetxt('./DNABert/examples/DeepSea_data/6_mediem/dev.tsv.gz', test_kmers, fmt='%s', delimiter='\t')

print("starting training 6-mers")
train_kmers = get_kmers(train_inputs, train_labels, dna_dict, k)
np.savetxt('./DNABert/examples/DeepSea_data/6_mediem/train.tsv.gz', train_kmers, fmt='%s', delimiter='\t')
